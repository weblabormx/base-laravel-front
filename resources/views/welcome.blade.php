...
<body class="antialiased">
    ...
    <div class="bg-white">
            ...
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="relative shadow-xl sm:overflow-hidden sm:rounded-2xl">
                    ...
                    <div class="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                        ...
                        <p class="mx-auto mt-6 max-w-lg text-xl text-center text-blue-200 sm:max-w-3xl">Keep track of
                            all your wallets and transactions in one place.</p>
        ...
        <div class="bg-gray-100">
            <div class="px-4 py-16 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <p class="text-base font-semibold text-center text-gray-500">Powered By Sea Cow Token (HASH)</p>
            </div>
        </div>
    ...
    <!-- This example requires Tailwind CSS v2.0+ -->
    <div class="overflow-hidden relative pt-16 pb-32 bg-white">
        <div class="relative">
            <div class="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8">
                <div class="px-4 mx-auto max-w-xl sm:px-6 lg:mx-0 lg:max-w-none lg:py-16 lg:px-0">
                    <div>
                        <div>
                            <span class="flex justify-center items-center w-12 h-12 bg-blue-600 rounded-md">
                        ...
                        <div class="mt-6">
                            ...
                            <div class="mt-6">
                                <a href="#"
                                    class="inline-flex px-4 py-2 text-base font-medium text-white bg-blue-600 rounded-md border border-transparent shadow-sm hover:bg-blue-700">Get
                                    started</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <blockquote>
                            <div>
                                <p class="text-base text-gray-500">
                                    Using Hierarchical Deterministic (HD) wallets you can create the N number of wallets
                                    you want quickly, easily and securely.
                                </p>
                            </div>
                            <footer class="mt-3">
                            </footer>
                ...
                <div class="mt-12 sm:mt-16 lg:mt-0">
                    <div class="pl-4 -mr-48 sm:pl-6 md:-mr-16 lg:relative lg:m-0 lg:h-full lg:px-0">
                        <img class="w-full rounded-xl ring-1 ring-black ring-opacity-5 shadow-xl lg:absolute lg:left-0 lg:h-full lg:w-auto lg:max-w-none"
            ...
            <div class="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8">
                <div class="px-4 mx-auto max-w-xl sm:px-6 lg:col-start-2 lg:mx-0 lg:max-w-none lg:py-32 lg:px-0">
                    <div>
                        ...
                        <div class="mt-6">
                            ...
                            <div class="mt-6">
                                <a href="#"
                                    class="inline-flex px-4 py-2 text-base font-medium text-white bg-blue-600 rounded-md border border-transparent shadow-sm hover:bg-blue-700">Documentation</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="mt-12 sm:mt-16 lg:col-start-1 lg:mt-0">
                    <div class="pr-4 -ml-48 sm:pr-6 md:-ml-16 lg:relative lg:m-0 lg:h-full lg:px-0">
                        <img class="w-full rounded-xl ring-1 ring-black ring-opacity-5 shadow-xl lg:absolute lg:right-0 lg:h-full lg:w-auto lg:max-w-none"
